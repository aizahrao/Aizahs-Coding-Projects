...
// Revised Spring 2020 so that the id now has a four-character textual
// prefix, so cell13 not 13

function getImage (id) {
    if( typeof(id) != typeof('cell13') ) {
	throw Error("argument should be a string like 'cell13' "+id);
    }
    var index = id.substring(4);
    var cell = parseInt(index,10);
